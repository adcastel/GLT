...
//GLT_returnvoid glt_loop_step(const size_t start, const size_t end, 
...
/*GLT_return void glt_loop_future(const size_t start, const size_t end, 
         const GLT_loop_f func, void * arg){
    qt_loop_future(start,end,func,arg);
}

GLT_return void glt_loop_step_future(const size_t start, const size_t end, 
        const size_t stride, const GLT_loop_step_f func, void * arg){
...
/* GLT_return void glt_loop_balance_future(const size_t start, const size_t end, 
         const GLT_loop_f func, void * arg){
...
/*GLT_return void glt_loopaccum_balance_future(const size_t start, const size_t end, 
