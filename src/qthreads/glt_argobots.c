...
GLT_return int glt_can_event_functions()
{
    return 0;
}
...
GLT_return int glt_can_manage_threads()
{
    return 0;
}

GLT_return int can_extended_tasklets()
{
    return 0;
}

GLT_return int can_extended_ults()
{
    return 0;
}
...
//Null codes
GLT_return void glt_get_error_str(int errno, char *str, size_t *len)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_event_add_callbac(GLT_event_kind event, GLT_event_cb_fn ask_cb,
...
GLT_return void glt_event_del_callback(GLT_event_kind event, int cb_id)
{
    GLT_ERROR_ARG;
}
...
GLT_return void glt_thread_create(GLT_sched sched, GLT_thread *newthread)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_create_basic(GLT_sched_predef predef, int num_pools,
        GLT_pool *pools, GLT_sched_config config, GLT_thread *newthread)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_start(GLT_thread thread)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_free(GLT_thread *thread)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_join(GLT_thread thread)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_exit()
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_cancel(GLT_thread *thread)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_self(GLT_thread *thread)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_self_rank(int *rank)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_get_rank(GLT_thread thread, int *rank)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_set_main_sched(GLT_thread thread, GLT_sched sched)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_set_main_sched_basic(GLT_thread thread,
        GLT_sched_predef predef, int num_pools, GLT_pool *pools)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_get_main_sched(GLT_thread thread, GLT_sched *sched)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_get_main_pools(GLT_thread thread, int max_pools,
        GLT_pool *pools)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_get_state(GLT_thread thread, GLT_thread_state *state)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_equal(GLT_thread thread1, GLT_thread thread2, GLT_bool *result)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_get_num(int *num_xstreams)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_is_primary(GLT_thread thread, GLT_bool *flag)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_run_unit(GLT_unit unit, GLT_pool pool)
{
    GLT_ERROR_ARG;
}

GLT_return void glt_thread_check_events(GLT_sched sched)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_tasklet_get_thread(GLT_tasklet tasklet, GLT_thread *thread)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_tasklet_get_state(GLT_tasklet tasklet, GLT_tasklet_state *state)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_tasklet_get_last_pool(GLT_tasklet tasklet, GLT_pool *pool)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_tasklet_get_last_pool_id(GLT_tasklet tasklet,int *id)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_tasklet_set_migratable(GLT_tasklet tasklet, GLT_bool flag)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_tasklet_is_migratable(GLT_tasklet tasklet,GLT_bool *flag)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_tasklet_equal(GLT_tasklet tasklet1, GLT_tasklet tasklet2, GLT_bool *result)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_tasklet_retain(GLT_tasklet tasklet)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_tasklet_release(GLT_tasklet tasklet)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_tasklet_get_arg(GLT_tasklet tasklet, void **arg)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_get_state(GLT_ult ult, GLT_ult_state *state)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_get_last_pool(GLT_ult ult, GLT_pool *pool)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_get_last_pool_id(GLT_ult ult, int *id)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_resume(GLT_ult ult)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_migrate_to_thread(GLT_ult ult, GLT_thread thread)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_migrate_to_scheduler(GLT_ult ult, GLT_sched sched)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_migrate_to_pool(GLT_ult ult, GLT_pool pool)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_migrate(GLT_ult ult)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_set_callback(GLT_ult ult,void(*cb_func)(GLT_ult ult, void *cb_arg), void *cb_arg)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_set_migratable (GLT_ult ult, GLT_bool flag)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_is_migratable(GLT_ult ult, GLT_bool *flag)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_is_primary(GLT_ult ult, GLT_bool *flag)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_equal(GLT_ult ult1, GLT_ult ult2, GLT_bool * result)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_retain(GLT_ult ult)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_release(GLT_ult ult)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_get_stacksize(GLT_ult ult, size_t *stacksize)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_get_arg(GLT_ult ult, void **arg)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_attr_create (GLT_ult_attr *newattr)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_attr_free(GLT_ult_attr *attr)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_attr_set_stacksize (GLT_ult_attr attr, size_t stacksize)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_attr_get_stacksize (GLT_ult_attr attr, size_t *stacksize)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_attr_set_callback (GLT_ult_attr attr, void(*cb_func)(GLT_ult ult, void *cb_arg), void *cb_arg)
{
    GLT_ERROR_ARG;
}

GLT_return  void glt_ult_attr_set_migratable (GLT_ult_attr attr, GLT_bool flag)
{
    GLT_ERROR_ARG;
}
